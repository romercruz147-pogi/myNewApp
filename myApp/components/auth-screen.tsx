...
const styles = StyleSheet.create({
  ...
  chipBody: { width: 34, height: 34, borderRadius: 8, borderWidth: 2, borderColor: '#60A5FA', alignItems: 'center', justifyContent: 'center' },
  chipCore: { width: 10, height: 10, borderRadius: 3, backgroundColor: '#60A5FA' },
  wifiArcLarge: { position: 'absolute', width: 27, height: 27, borderWidth: 2, borderColor: '#38BDF8', borderBottomColor: 'transparent', borderLeftColor: 'transparent', borderRightColor: 'transparent', borderRadius: 16, top: -12 },
  wifiArcSmall: { position: 'absolute', width: 16, height: 16, borderWidth: 2, borderColor: '#38BDF8', borderBottomColor: 'transparent', borderLeftColor: 'transparent', borderRightColor: 'transparent', borderRadius: 10, top: -7 },
  ...
  primaryButton: { height: 54, borderRadius: 18, backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center' },
  ...
  secondaryButton: { height: 54, borderRadius: 18, borderWidth: 1, borderColor: '#3F3F46', backgroundColor: '#161616', alignItems: 'center', justifyContent: 'center' },
  googleDot: { position: 'absolute', left: 22, top: 21, width: 12, height: 12, borderRadius: 6, backgroundColor: '#3B82F6' },
